<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <form class="form-group" action="<?php echo base_url() ?>motorcycles/savemotorcycle" method="post">
              <div class="row">
              <div class="col-md-5">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="motorcycle_plate" name="motorcycle_plate" placeholder="Placa do veiculo">
                  </div>
                </div>
                <div class="col-md-2">
