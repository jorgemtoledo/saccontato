              ...
              <input type="hidden" id="id" name="id" value="<?php echo $result->indid; ?>">
                ...
                <div class="form-group">
                 <div class="col-md-3">
                    ...
                    <div class='input-group date' id='data'>
                              <input type='text' class="form-control" id="data" name="date_sale" value="<?php echo date( "d/m/Y", strtotime( $result->inddate_sale ) ) ?>"  placeholder="DD/MM/AAAA" maxlength="10" minlength="10" OnKeyPress="formatar('##/##/####', this)"  required />
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" id="hour_sac" name="hour_sale" value="<?php echo $result->indhour_sale; ?>" placeholder="Hora: 12:00" maxlength="5" minlength="5" OnKeyPress="formatar('##:##', this)"  required/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-4">
                    ...
                    <select id="feedbackindication" name="feedbackindication" class="form-control" >
                ...
                <div class="col-md-3">
                    ...
                    <div class='input-group date' id='data'>
                              <input type='text' class="form-control" id="data" name="date_contract" value="<?php echo date( "d/m/Y", strtotime( $result->inddate_contract ) ) ?>"  placeholder="DD/MM/AAAA" maxlength="10" minlength="10" OnKeyPress="formatar('##/##/####', this)"  required/>
                              <span class="input-group-addon">
                                  <span class="glyphicon glyphicon-calendar"></span>
                              </span>
                    </div>
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" id="number_contract" name="number_contract" value="<?php echo $result->indnumber_contract; ?>"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-4">
                    ...
                    <select id="signed_contract" name="signed_contract" class="form-control">
                ...
                <label>Porque Não fechou?</label>
                        <div class="row">
                          <div class="col-md-11">
                            <textarea class="form-control" id="description_contract" name="description_contract"  rows="4"><?php echo $result->inddescription_contract; ?></textarea><br/>
                          </div>
                        </div>
