              ...
              <form class="form-horizontal" role="form" action="<?php echo base_url() ?>treatments/savernctreatment" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-11">
                    ...
                    <input type="text" class="form-control" id="complaint_rnc" name="complaint_rnc" value="<?php echo $result->tcomplaint_rnc; ?>" placeholder="Informe" required>
                  </div>
                  <div class="col-sm-11">
                    <label for="suggestion_rnc">Sugestão:</label>
                    <input type="text" class="form-control" id="suggestion_rnc" name="suggestion_rnc" value="<?php echo $result->tsuggestion_rnc; ?>"  required>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="description_rnc" name="description_rnc"  rows="4" required> <?php echo $result->tdescription_rnc; ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="other_sector" name="other_sector" value="<?php echo $result->tother_sector; ?>" >
                </div>
                </div>
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="responsible_operational" name="responsible_operational" value="<?php echo $result->tresponsible_operational; ?>" >
                </div>
                <div class="col-sm-7">
                    <label for="description_operational">Descrição Operacional</label>
                    <input type="text" class="form-control" id="description_operational" name="description_operational" value="<?php echo $result->tdescription_operational; ?>">
                </div>
                <div class="col-sm-4">
                    <label for="responsible_collection">Responsavel Cobrança</label>
                    <input type="text" class="form-control" id="responsible_collection" name="responsible_collection" value="<?php echo $result->tresponsible_collection; ?>" >
                </div>
                <div class="col-sm-7">
                    <label for="description_collection">Descrição Cobrança</label>
                    <input type="text" class="form-control" id="description_collection" name="description_collection" value="<?php echo $result->tdescription_collection; ?>" >
                </div>

                <div class="col-sm-4">
                    <label for="responsible_quality">Responsavel QualiClinica</label>
                    <input type="text" class="form-control" id="responsible_quality" name="responsible_quality" value="<?php echo $result->tresponsible_quality; ?>" >
                </div>
                <div class="col-sm-7">
                    <label for="description_quality">Descrição QualiClinica</label>
                    <input type="text" class="form-control" id="description_quality" name="description_quality" value="<?php echo $result->tdescription_quality; ?>" >
                </div>

                <div class="col-sm-4">
                    <label for="responsible_financial">Responsavel Financeiro</label>
                    <input type="text" class="form-control" id="responsible_financial" name="responsible_financial" value="<?php echo $result->tresponsible_financial; ?>" >
                </div>
                <div class="col-sm-7">
                    <label for="description_financial">Descrição Financeiro</label>
                    <input type="text" class="form-control" id="description_financial" name="description_financial" value="<?php echo $result->tdescription_financial; ?>" >
                </div>

                <div class="col-sm-4">
                    <label for="responsible_commercial">Responsavel Comercial</label>
                    <input type="text" class="form-control" id="responsible_commercial" name="responsible_commercial" value="<?php echo $result->tresponsible_commercial; ?>">
                </div>
                <div class="col-sm-7">
                    <label for="description_commercial">Descrição Comercial</label>
                    <input type="text" class="form-control" id="description_commercial" name="description_commercial" lue="<?php echo $result->tdescription_commercial; ?>" >
                </div>

                <div class="col-sm-4">
                    <label for="responsible_event">Responsavel Eventos</label>
                    <input type="text" class="form-control" id="responsible_event" name="responsible_event" value="<?php echo $result->tresponsible_event; ?>" >
                </div>
                <div class="col-sm-7">
                    <label for="description_event">Descrição Eventos</label>
                    <input type="text" class="form-control" id="description_event" name="description_event" value="<?php echo $result->tdescription_event; ?>" >
                </div>

                <div class="col-sm-4">
                    <label for="responsible_other">Responsavel Outros</label>
                    <input type="text" class="form-control" id="responsible_other" name="responsible_other" value="<?php echo $result->tresponsible_other; ?>"  >
                </div>
                <div class="col-sm-7">
                    <label for="description_other">Descrição Outros</label>
                    <input type="text" class="form-control" id="description_other" name="description_other" value="<?php echo $result->tdescription_other; ?>" >
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="information_rnc" name="information_rnc"  rows="4" required><?php echo $result->tinformation_rnc; ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="corrective_rnc" name="corrective_rnc"  rows="4" required><?php echo $result->tcorrective_rnc; ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="preventive_rnc" name="preventive_rnc"  rows="4" required><?php echo $result->tpreventive_rnc; ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="conclusion_rnc" name="conclusion_rnc"  rows="4" required><?php echo $result->tconclusion_rnc; ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        ...
                        <a class="btn btn-success" href="<?php echo base_url() ?>treatments/listrnc" ><i class="glyphicon glyphicon-list-alt"></i>   Listar </a>
                    </div>
                </div>
            </form>
