      ...
      <div class="panel panel-success">
          ...
          <div class="panel-body">
              ...
              <form class="form-horizontal" role="form" action="<?php echo base_url() ?>treatments/savernctreatmentreturn" method="post">
                ...
                <div class="form-group">
                  <div class="col-md-3">
                    ...
                    <div class='input-group date' id='date_return'>
                      <input type='text' class="form-control" id="data" name="date_return" placeholder="DD/MM/AAAA" value="<?php echo date( "d/m/Y", strtotime( $result->tdate_return ) ) ?>"   maxlength="10" minlength="10" OnKeyPress="formatar('##/##/####', this)"  disabled/>
                      <span class="input-group-addon">
                          <span class="glyphicon glyphicon-calendar"></span>
                      </span>
                    </div>
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" id="data" name="hour_return" placeholder="12:00" value="<?php echo $result->thour_return; ?>" maxlength="5" minlength="5" OnKeyPress="formatar('##:##', this)"  disabled>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="information_return" name="information_return"  rows="4" disabled><?php echo $result->tinformation_return ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="corrective_return" name="corrective_return"  rows="4" disabled><?php echo $result->tcorrective_return ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="preventive_return" name="preventive_return"  rows="4" disabled><?php echo $result->tpreventive_return ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                    <textarea class="form-control" id="conclusion_return" name="conclusion_return"  rows="4" disabled><?php echo $result->tconclusion_return ?></textarea><br />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select id="feedbackreturn" name="feedbackreturn" class="form-control" disabled>
                    <option value=""> Selecione </option>
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        ...
                        <a href="<?php echo base_url('treatments/editrncreturn/'.$result->tid); ?>" class="btn btn-primary btn-group"><i class="glyphicon glyphicon-pencil"></i>Editar</a>
                    </div>
                </div>
